...
public class sqlString extends connectSQL {
	...
	Connection connection = conn.dbConnector();
	...
	public void SQLSETRemoveStack(String textField_LastF) throws SQLException {
		System.out.println("sqlSetRemoveQStack... Running");
		String sqlRemove = "delete from departures where Flight = ?";
		PreparedStatement pst = connection.prepareStatement(sqlRemove);
		pst.setString(1, textField_LastF);
		pst.executeUpdate();
		System.out.println("sqlSetRemoveStack... Done");
